...
@section('content')
    ...
    <div class="container">
        <p><a href="{{ url('backend/archive') }}" class="btn btn-default btn-sm"><i class="fa fa-arrow-left"></i>Retour</a></p>
        <div class="row">
                    ...
                    <div class="card-body list-dates">
                        ...
                        @if(!$decisions->isEmpty())
                            @foreach($decisions as $decision)
                                <div class="row">
                                    <div class="col-sm">
                                        <p><a href="{{ url('backend/decision/'.$date.'/'.$decision->id) }}">{{ $decision->numero }}</a></p>
                                    </div>
