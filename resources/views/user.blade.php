            ...
            <div class="col-md-8">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ secure_url('user') }}" class="contact-form-validated contact-one__form" novalidate="novalidate">@csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" name="npa" value="{{ $user->npa }}" required placeholder="NPA">
                                </div>
                                <div class="col-lg-6">
