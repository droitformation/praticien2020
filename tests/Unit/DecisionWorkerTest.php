...
class DecisionWorkerTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->decision = \Mockery::mock('App\Praticien\Bger\Utility\Decision');
        $this->list     = \Mockery::mock('App\Praticien\Bger\Utility\Liste');
        $this->repo     = \Mockery::mock('App\Praticien\Decision\Repo\DecisionInterface');
        $this->worker   = \Mockery::mock('App\Praticien\Categorie\Worker\CategorieWorkerInterface');
        $this->failed   = \Mockery::mock('App\Praticien\Decision\Repo\FailedInterface');
    }
